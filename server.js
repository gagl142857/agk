  ...
  while (나.스탯.최종HP > 0 && 상대.스탯.최종HP > 0) {
    ...
    if (turn === "나") {
      ...
      if (!Math.random() * 100 < 상대.스탯.관통무시) {
        기본데미지 = Math.max(1, 나.스탯.최종공격력 - 상대.스탯.최종방어력 * ((Math.max(0, 100 - 나.스탯.관통)) / 100));
      }
      let 최종데미지 = 기본데미지;
      ...
      if (!Math.random() * 100 < 나.스탯.관통무시) {
        기본데미지 = Math.max(1, 상대.스탯.최종공격력 - 나.스탯.최종방어력 * ((Math.max(0, 100 - 상대.스탯.관통)) / 100));
      }
      let 최종데미지 = 기본데미지;
