...
//   let 나스턴발동 = Math.random() * 100 < 나.스탯.스턴;
//   let 상대치명무시발동 = Math.random() * 100 < 상대.스탯.치명무시;
//   let 상대회피발동 = Math.random() * 100 < 상대.스탯.회피;
//   let 나회피무시발동 = Math.random() * 100 < 나.스탯.회피무시;
//   let 상대반격발동 = Math.random() * 100 < 상대.스탯.반격;
//   let 나반격무시발동 = Math.random() * 100 < 나.스탯.반격무시;
//   let 나회피발동 = Math.random() * 100 < 나.스탯.회피;
//   let 상대회피무시발동 = Math.random() * 100 < 상대.스탯.회피무시;
//   let 나콤보발동 = Math.random() * 100 < 나.스탯.콤보;
//   let 상대콤보무시발동 = Math.random() * 100 < 상대.스탯.콤보무시;

//   let 나기본 =
//     (나.스탯.최종공격력
//       - (상대.스탯.최종방어력
//         * Math.max(0.1, (100 - (Math.max(나.스탯.관통 - 상대.스탯.관통무시, 0))) * 0.01)))
//     * Math.max(0.1, (100 - 상대.스탯.피해감소) * 0.01)
//     * ((100 + 나.스탯.추가데미지) * 0.01);

//   let 나일반 =
//     (나.스탯.일반공격계수 * 0.01)
//     * (Math.max(0.1, (100 - 상대.스탯.일반공격피해감소)) * 0.01);

//   let 나치명 =
//     (나.스탯.치명피해 * 0.01)
//     * (Math.max(0.1, (100 - 상대.스탯.치명저항)) * 0.01);

//   let 나콤보 =
//     (나.스탯.콤보계수 * 0.01)
//     * (Math.max(0.1, (100 - 상대.스탯.콤보피해감소)) * 0.01);

//   let 나반격 =
//     (나.스탯.반격계수 * 0.01)
//     * (Math.max(0.1, (100 - 상대.스탯.반격피해감소)) * 0.01);

//   let 나스킬치명 =
//     (나.스탯.스킬치명피해 * 0.01)
//     * (나.스탯.스킬피해 * 0.01)
//     * (Math.max(0.1, (100 - 상대.스탯.스킬피해감소)) * 0.01);
...
//     (나.스탯.동료치명피해 * 0.01)
//     * (나.스탯.동료피해 * 0.01)
//     * (Math.max(0.1, (100 - 상대.스탯.동료피해감소)) * 0.01);
...
//     (상대.스탯.최종공격력
//       - (나.스탯.최종방어력
//         * Math.max(0.1, (100 - (Math.max(상대.스탯.관통 - 나.스탯.관통무시, 0))) * 0.01)))
//     * Math.max(0.1, (100 - 나.스탯.피해감소) * 0.01)
//     * ((100 + 상대.스탯.추가데미지) * 0.01);
